function [Z,E,A,J,W,obj]=LRSR_FGC(X, D, lambda, alpha, beta, WW, M)
...
% in the paper entitled "Low-rank Sparse Representation-based Fuzzy Gaussian Clustering Algorithm for Image Segmentation".
%------------------------------
